...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButtonTimerStart_2 = QPushButton(self.frame)
        self.pushButtonTimerStart_2.setObjectName(u"pushButtonTimerStart_2")
        self.pushButtonTimerStart_2.setCheckable(True)

        self.verticalLayout.addWidget(self.pushButtonTimerStart_2)
        ...
        self.pushButtonUrlCheckStart_2 = QPushButton(self.frame_2)
        self.pushButtonUrlCheckStart_2.setObjectName(u"pushButtonUrlCheckStart_2")
        self.pushButtonUrlCheckStart_2.setCheckable(True)

        self.verticalLayout_2.addWidget(self.pushButtonUrlCheckStart_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButtonTimerStart.setText(QCoreApplication.translate("Form", u"\u0421\u0442\u0430\u0440\u0442", None))
        self.pushButtonTimerStart_2.setText(QCoreApplication.translate("Form", u"\u0424\u0438\u043d\u0438\u0448", None))
        ...
        self.pushButtonUrlCheckStart_2.setText(QCoreApplication.translate("Form", u"\u0424\u0438\u043d\u0438\u0448", None))
